...
from agente_grok import AgenteGrok
import json
import sys

def simular_grok_completo():
    print("Iniciando simulación completa con Grok (180 días)...", flush=True)
    ...
    try:
        ...
        with open("resultado_grok.json", "w") as f:
