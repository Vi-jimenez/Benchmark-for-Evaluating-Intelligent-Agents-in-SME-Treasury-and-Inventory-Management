...
def simular_gemini_completo():
    print("Iniciando simulación completa con Gemini Pro (180 días)...", flush=True)
    ...
    try:
        ...
        with open("resultado_gemini.json", "w") as f:
